...
namespace NetApiStarterApp.Repository.Vehicle
{
    public interface IVehicleService
    {
        ...
        public Task<VehicleModel> AddVehicleAsync(AddVehicleDto crudModel); //adds new vehicle data
        public Task<VehicleModel> UpdateVehicleAsync(UpdateVehicleDto crudModel); //update vehicle data
